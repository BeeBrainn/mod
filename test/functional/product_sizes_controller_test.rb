...
class ProductSizesControllerTest < ActionController::TestCase
  ...
  test "should create product_size" do
    assert_difference('ProductSize.count') do
      post :create, product_size: { count: @product_size.count, name: @product_size.name, price: @product_size.price, reserv: @product_size.reserv }
    end
  ...
  test "should update product_size" do
    put :update, id: @product_size, product_size: { count: @product_size.count, name: @product_size.name, price: @product_size.price, reserv: @product_size.reserv }
    assert_redirected_to product_size_path(assigns(:product_size))
  end
